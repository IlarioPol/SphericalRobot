...
%% ------------------------------------------------------------------------   
    ...
    joy = vrjoystick(1);  % Access the first joystick device (may vary depending on your system)
    ...
    while n < N
        ...
        while i <= 10 && n < N 
              ...
              % Read joystick input
              [axes, buttons] = read(joy);  % Replace with your joystick input reading method
